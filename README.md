...
to read the pump's device id and local key straight out of the vendor app,
without re-pairing it or touching a Tuya developer account
([`tools/dump_local_keys.js`](tools/dump_local_keys.js)).
